...
const menuPage = function() {
    ...
    Chashao.style.margin = "740px 0px 0px -410px"
    Chashao.style.height = "40px"
    Chashao.style.width = "230px"
    Chashao.style.display = "flex"
    Chashao.style.opacity = "0.8"
    Chashao.style.backgroundColor = "white"
    Chashao.style.border = "1px solid black"

    Miantiao.style.position = "absolute"
    Miantiao.style.margin = "800px 0px 0px -410px"
    Miantiao.style.height = "40px"
    Miantiao.style.width = "230px"
    Miantiao.style.display = "flex"
    Miantiao.style.opacity = "0.8"
    Miantiao.style.backgroundColor = "white"
    Miantiao.style.border = "1px solid black"

    Chaomian.style.position = "absolute"
    Chaomian.style.margin = "900px 0px 0px -410px"
    Chaomian.style.height = "43px"
    Chaomian.style.width = "230px"
    Chaomian.style.display = "flex"
    Chaomian.style.opacity = "0.8"
    Chaomian.style.backgroundColor = "white"
    Chaomian.style.border = "1px solid black"

    Tangmian.style.position = "absolute"
    Tangmian.style.margin = "960px 0px 0px -410px"
    Tangmian.style.height = "43px"
    Tangmian.style.width = "230px"
    Tangmian.style.display = "flex"
    Tangmian.style.opacity = "0.8"
    Tangmian.style.backgroundColor = "white"
    Tangmian.style.border = "1px solid black"

    Zhajiangmian.style.position = "absolute"
    Zhajiangmian.style.margin = "1010px 0px 0px -410px"
    Zhajiangmian.style.height = "43px"
    Zhajiangmian.style.width = "230px"
    Zhajiangmian.style.display = "flex"
    Zhajiangmian.style.opacity = "0.8"
    Zhajiangmian.style.backgroundColor = "white"
    Zhajiangmian.style.border = "1px solid black"

    Lamian.style.position = "absolute"
    Lamian.style.margin = "1080px 0px 0px -410px"
    Lamian.style.height = "43px"
    Lamian.style.width = "230px"
    Lamian.style.display = "flex"
    Lamian.style.opacity = "0.8"
    Lamian.style.backgroundColor = "white"
    Lamian.style.border = "1px solid black"

    BeijingKaoya.style.position = "absolute"
    BeijingKaoya.style.margin = "1160px 0px 0px -410px"
    BeijingKaoya.style.height = "43px"
    BeijingKaoya.style.width = "230px"
    BeijingKaoya.style.display = "flex"
    BeijingKaoya.style.opacity = "0.8"
    BeijingKaoya.style.backgroundColor = "white"
    BeijingKaoya.style.border = "1px solid black"

    Hongzaoji.style.position = "absolute"
    Hongzaoji.style.margin = "1240px 0px 0px -410px"
    Hongzaoji.style.height = "45px"
    Hongzaoji.style.width = "230px"
    Hongzaoji.style.display = "flex"
    Hongzaoji.style.opacity = "0.8"
    Hongzaoji.style.backgroundColor = "white"
    Hongzaoji.style.border = "1px solid black"

    LuohanZhai.style.position = "absolute"
    LuohanZhai.style.margin = "1340px 0px 0px -410px"
    LuohanZhai.style.height = "43px"
    LuohanZhai.style.width = "230px"
    LuohanZhai.style.display = "flex"
    LuohanZhai.style.opacity = "0.8"
    LuohanZhai.style.backgroundColor = "white"
    LuohanZhai.style.border = "1px solid black"

    GeneralTaoChicken.style.position = "absolute"
    GeneralTaoChicken.style.margin = "1425px 0px 0px -410px"
    GeneralTaoChicken.style.height = "43px"
    GeneralTaoChicken.style.width = "230px"
    GeneralTaoChicken.style.display = "flex"
    GeneralTaoChicken.style.opacity = "0.8"
    GeneralTaoChicken.style.backgroundColor = "white"
    GeneralTaoChicken.style.border = "1px solid black"
